...
!
  ...
  use diags_module,only: mkdiag_JE13D, mkdiag_JE23D, mkdiag_KQLAM, &
    mkdiag_KQPHI, mkdiag_JQR, mkdiag_KQPHI_110
  implicit none
...
! Kedeng Zhang, 2019/08
  real,dimension(mlon0:mlon1,mlat0:mlat1) :: kqphi2d_110,kqlam_110
...
! Kedeng Zhang, 2019/08
        if (k>=9 .and. k<=19) then
          kqphi2d_110(i,j) = kqphi2d_110(i,j) + 0.5*(actpk+act)*je13d(i,j,k)*dh
        endif
      enddo ! k=mlev0,mlev1-1
    enddo ! i=mlon0,mlon1
...
! Kedeng Zhang, 2019/08
  call mkdiag_KQPHI_110('KQPHI_110',kqphi2d_110(mlon0:mlon1,mlat0:mlat1),mlon0,mlon1,mlat0,mlat1)
!
